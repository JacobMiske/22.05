...
waterMaxFromOriginSumDistance = max(waterMaxFromOriginTotalDistancePerN);
...
% end
% %Run square root and then mean all values
% graphiteMeanSquareCrowFlight = sqrt(graphiteMeanSquareCrowFlight);
...
% end
% %Run square root and then mean all values
% D2OMeanSquareCrowFlight = sqrt(D2OMeanSquareCrowFlight);
